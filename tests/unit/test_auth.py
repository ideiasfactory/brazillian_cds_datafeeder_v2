...
class TestAPIKeyRepository:
    ...
    async def test_list_api_keys(self, api_key_repository: APIKeyRepository):
        ...
        await api_key_repository.create_key(key=secrets.token_urlsafe(32), name="Key 1", description="Description 1")
        await api_key_repository.create_key(key=secrets.token_urlsafe(32), name="Key 2", description="Description 2")
        await api_key_repository.create_key(key=secrets.token_urlsafe(32), name="Key 3", description="Description 3")
    ...
    async def test_get_api_key_by_id(self, api_key_repository: APIKeyRepository):
        ...
        api_key = secrets.token_urlsafe(32)
        record = await api_key_repository.create_key(key=api_key, name="Test Key", description="Test")
    ...
    async def test_get_api_key_by_id_not_found(self, api_key_repository: APIKeyRepository):
