...
from sqlalchemy import Column, Integer, Float, Date, DateTime, Index, String, Boolean, Text
...
class APIKey(Base):
    ...
    # Key metadata
    name = Column(String(100), nullable=False)  # Friendly name (e.g., "GitHub Actions", "Production App")
    ...
    # Usage tracking
    request_count = Column(Integer, default=0, nullable=False)  # Total requests made with this key
